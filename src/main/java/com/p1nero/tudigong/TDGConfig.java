...
public class TDGConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue GENERATE_TEMPLE = BUILDER.comment("Whether to generate TuDiTemple in villages").define("generate_temple", false);
